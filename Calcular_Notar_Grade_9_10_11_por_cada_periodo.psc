Algoritmo Calcular_Notar_Grade_10_11
	// Emmpezamos con Definir las.. 
	// ¿para que es Definir?
	Definir Nota_P1,Nota_P2,Nota_P3,Nota_P4,Calificaciones,Total Como Real
	Definir Name Como Caracter
	Definir Grade_PP Como Entero
	...
	Repetir
		Escribir '';
		Escribir Name " del Grado "  Grade_PP ' ¿Que periodo vas a registrar?';
		...
		Si respuesta=1 Entonces
			...
			Si Promedio<3.5 Entonces
				Escribir Name ' Tu promedio esta bajo el 3.5 ";
				Mostrar "(No pasaste el periodo)';
				Escribir 'Debes mejorar';
			FinSi
			Si Promedio>=3.5 Entonces
				Escribir Name ' Estas en el promedio del 3.5 de la nota (Bien hecho)';
			FinSi
			Si Promedio>=4.0 Entonces
				Escribir Name ' Estas en el promedio del 4.0 de la nota (Felicitaciones)';
			FinSi
			Si Promedio>=4.5 Entonces
				Escribir Name ' Estas en el promedio del 4.5 de la nota (Asombroso eres de los mejores)';
			FinSi
		FinSi
		//SE REMPLAZA EL 1 AL 2
		//SE CAMBIA EL TIPO DE PERIODO DE PRIMER A SEGUNDO Y SEUCESIVAMENTE
		...
		Si respuesta=4 Entonces
			...
			Escribir ''
			Si Promedio<3.5 Entonces
				Escribir Name ' Tu promedio esta bajo el 3.0";
				Mostrar "(No pasaste el periodo)';
				Escribir 'Debes mejorar';
			FinSi
			Si Promedio>=3.5 Entonces
